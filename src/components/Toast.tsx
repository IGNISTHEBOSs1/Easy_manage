...
export default function Toast({ message, type = 'success', onClose }: ToastProps) {
  ...
  const icons = {
    ...
    error:   <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>,
  ...
  return (
    <div className={`toast ${styles[type]}`}>
      ...
      <button onClick={onClose} className="ml-1 opacity-75 hover:opacity-100 shrink-0">
